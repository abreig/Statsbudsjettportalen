...
export const ALL_STATUSES = ['draft', 'under_arbeid', 'til_avklaring', 'klarert', 'godkjent_pol', 'sendt_til_fin', 'under_vurdering_fin', 'returnert_til_fag', 'ferdigbehandlet_fin'];
